...
export default class TestimonialBubble {
  constructor(x, y, text, r, noCircles, canvasWidth, canvasHeight) {
    ...
    this.text.fontFamily = 'Graphik-Bold'
    this.text.justification = "center"
    this.text.position.y -= this.text.bounds.height * 0.5

    this.authorText = new paper.PointText(new paper.Point(this.renderCircle.position.x, this.renderCircle.position.y))
    ...
    this.authorText.position.y += this.text.bounds.height * 0.55
